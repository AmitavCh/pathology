            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ URL::to('setting/add_city_data')}}" class="iframeD" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add City</button></a>
                    </div>
                </div>
                <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-3 margine10bot"> 
                                    <div class="form-group">
                                        <input type="text" name="search_city_name" maxlength="25" class="form-control" id="search_city_name" placeholder="Search By City Name" autocomplete="off"/>
                                    </div>
                                </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">							
                                        <a class="iframeD btn-sm" href="{{ URL::to('setting/add_city_data/'.base64_encode(base64_encode($resVal->id))) }}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        @if($resVal->status == "N")
                                        <a class="btn-sm" title="Active Record" onclick="cityActive({{ $resVal->id }})">
                                            <i class="fa fa-check-circle-o"></i>
                                        </a> 
                                        @endif
                                        @if($resVal->status == "Y")
                                        <a class="btn-sm" title="Deactive Record" onclick="cityDeactive({{ $resVal->id }})">

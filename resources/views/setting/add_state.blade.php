                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">							
                                        <a class="btn btn-primary btn-sm" href="{{ URL::to('setting/add_state/'.base64_encode(base64_encode($resVal->id))) }}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        @if($resVal->status == "N")
                                        <a class="btn btn-success btn-sm" title="Active Record" onclick="stateActive({{ $resVal->id }})">
                                            <i class="fa fa-check-circle-o"></i>
                                        </a> 
                                        @endif
                                        @if($resVal->status == "Y")
                                        <a class="btn btn-warning btn-sm" title="Deactive Record" onclick="stateDeactive({{ $resVal->id }})">

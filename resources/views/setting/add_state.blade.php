            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ URL::to('setting/add_state_data')}}" class="iframeD" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add State Name</button></a>
                    </div>
                </div>
                <div class="box-body">
                    ...
                    <div id="listingTable">
                        ...
                        <div class="table-responsive">            
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <td>{{ $trCnt }}</td>
                                    <td>{{$resVal->state_name}}</td>
                                    <td class="text-center">							
                                        <a class="iframeD btn-sm" href="{{ URL::to('setting/add_state_data/'.base64_encode(base64_encode($resVal->id))) }}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        @if($resVal->status == "N")
                                        <a class="btn-sm" title="Active Record" onclick="stateActive({{ $resVal->id }})">
                                            <i class="fa fa-check-circle-o"></i>
                                        </a> 
                                        @endif
                                        @if($resVal->status == "Y")
                                        <a class="btn-sm" title="Deactive Record" onclick="stateDeactive({{ $resVal->id }})">

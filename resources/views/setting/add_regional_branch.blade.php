    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <form action="{{ url('setting/saveRegionalBranch') }}" method="post" role="form" id="entryFrm" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group margine10bot">
                                ...
                                @if(isset($layoutArr['viewDataObjs']->address) && $layoutArr['viewDataObjs']->address != '')
                                    <textarea type="text" name="TBranchDetails[address]" class="form-control" rows="3" id="address" autocomplete="off">{{$layoutArr['viewDataObjs']->address}}</textarea>
                                @else
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">							
                                        ...
                                        <a class="btn btn-primary btn-sm" href="{{ URL::to('setting/add_regional_branch/'.base64_encode(base64_encode($resVal->id))) }}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        @if($resVal->status == 'N')
                                        <a class="btn btn-success btn-sm" title="Active Record" onclick="regionalBranchActive({{ $resVal->id }})">
                                            <i class="fa fa-check-circle-o"></i>
                                        </a> 
                                        @endif
                                        @if($resVal->status == 'Y')
                                        <a class="btn btn-warning btn-sm" title="Deactive Record" onclick="regionalBranchDeactive({{ $resVal->id }})">

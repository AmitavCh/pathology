                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-3">
                                ...
                                ?>
                                <label for="exampleInputEmail1"><img src="{{asset('public/uploads/public/item/orig/no.png')}}"  width="200" height="150"></label>
                                <?php }else{ ?>
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <table style="width:100%">
                                            <tr>
                                                ...
                                                <td width="20%">{{ $viewDataObj->fullname }}</td>
                                            </tr>
                                            <tr>
                                                <td width="5%"><b>Gender : </b></td>
                                                <td width="20%">{{ $viewDataObj->gender }}</td>
                                            </tr>
                                            <tr>
                                                <td><b>Mobile No  :</b></td>

            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ URL::to('branch/add_lab_collection_center_user_data/')}}" class="iframeLarge" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add Lab/Coll. Admin</button></a>
                    </div>
                </div>
                <div class="box-body">
                            ...
                            <table class="table table-bordered table-striped">
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td>{{Controller::getDisplayFieldName($resVal->t_business_logistic_dtl_id,'t_business_logistic_dtls',['business_logistic_name'])}}</td>
                                    ...
                                    <td class="text-center">							
                                        <a class="iframeLarge btn-sm" href="{{ URL::to('/branch/add_lab_collection_center_user_data/'.base64_encode(base64_encode($resVal->id))) }}">

            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ URL::to('branch/create_branch_user_data/')}}" class="iframeLarge" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add Branch Admin</button></a>
                    </div>
                </div>
                <div class="box-body">
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td class="text-center">							
                                        <a class="iframeLarge btn-sm" href="{{ URL::to('/branch/create_branch_user_data/'.base64_encode(base64_encode($resVal->id))) }}">

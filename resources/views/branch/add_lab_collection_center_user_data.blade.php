    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-body">
                    <form action="{{ url('branch/saveLabCollectionCenterUserDetails') }}" method="post" role="form" id="entryFrm" enctype="multipart/form-data">
                            ...
                            <div class="col-md-3">
                                <div class="form-group margine10bot">
                                    ...
                                    <select class="form-control" id="t_business_logistic_dtl_id" name="User[t_business_logistic_dtl_id]">
                                        @foreach($layoutArr['collArr'] as $menu)

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-body">
                    <form action="<?php echo e(url('branch/saveBranchUserDetails')); ?>" method="post" role="form" id="entryFrm" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.iframelightbox', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/branch/create_branch_user_data.blade.php ENDPATH**/ ?>
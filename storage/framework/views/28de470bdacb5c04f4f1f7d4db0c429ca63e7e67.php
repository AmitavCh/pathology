            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo e(URL::to('master/add_role_data/')); ?>" class="iframeD" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add Role</button></a>
                    </div>
                </div>
                <div class="box-body">
                        ...
                        <div class="table-responsive">            
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($resVal->role_name); ?></td>
                                    <td class="text-center">							
                                        <a class="iframeD btn-sm" title="Edit Record" href="<?php echo e(URL::to('/master/add_role_data/'.base64_encode(base64_encode($resVal->id)))); ?>">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <?php if($resVal->is_active == 1): ?>
                                        <a class="btn-sm" title="Active Record" onclick="ActiveRole(<?php echo e($resVal->id); ?>)">
                                            <i class="fa fa-check-circle-o"></i>
                                        </a> 
                                        <?php endif; ?>
                                        <?php if($resVal->is_active == 0): ?>
                                        <a class="btn-sm" title="Deactive Record" onclick="DeActiveRole(<?php echo e($resVal->id); ?>)">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/master/add_role.blade.php ENDPATH**/ ?>
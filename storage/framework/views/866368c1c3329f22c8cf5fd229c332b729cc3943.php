            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo e(URL::to('master/add_master_user_data/')); ?>" class="iframeLarge" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add Master Admin</button></a>
                    </div>
                </div>
                <div class="box-body">
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td class="text-center">							
                                        <a class="iframeLarge btn-sm" href="<?php echo e(URL::to('/master/add_master_user_data/'.base64_encode(base64_encode($resVal->id)))); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/master/add_master_user.blade.php ENDPATH**/ ?>
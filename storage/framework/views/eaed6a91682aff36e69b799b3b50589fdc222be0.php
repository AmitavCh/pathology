...
var listingUrl				=	'';	
    ...
    <?php endif; ?>
    <?php if($action == 'addDepartmentData'): ?>
    ...
    <?php endif; ?>
    <?php if($action == 'addDesignationData'): ?>
    ...
    <?php endif; ?>
    <?php if($action == 'createOrganizationUser'): ?>
        function ActiveUser(record_id){
            if (confirm('Are you sure to Active Record ?')){
                $('#loddingImage').show();
                $.ajaxSetup({
    ...
    <?php endif; ?>
    <?php if($action == 'addMasterUserData'): ?>
    ...
    <?php endif; ?>
    <?php if($action == 'createOrganizationUserData'): ?>
        function userValidate(){
            $('.registerBtn').prop('disabled',true);
            $('.imgLoader').show();
            $('.error-message').remove();
    ...
    <?php endif; ?>
    <?php if($action == 'addRegionalBranchData'): ?>
    ...
    <?php endif; ?>
    <?php if($action == 'createBranchUser'): ?>
        function ActiveUser(record_id){
            if (confirm('Are you sure to Active Record ?')){
                $('#loddingImage').show();
                $.ajaxSetup({
    ...
    <?php endif; ?>
    <?php if($action == 'createBranchUserData'): ?>
        function userValidate(){
            $('.registerBtn').prop('disabled',true);
            $('.imgLoader').show();
            $('.error-message').remove();
    ...
    <?php endif; ?>
    <?php if($action == 'addLabCollectionCenterUserData'): ?>
        function userValidate(){
            $('.registerBtn').prop('disabled',true);
            $('.imgLoader').show();
            $('.error-message').remove();
    ...
    <?php endif; ?>
    <?php if($action == 'addLabCollectionCenterUser'): ?>
        function ActiveUser(record_id){
            if (confirm('Are you sure to Active Record ?')){
                $('#loddingImage').show();
                $.ajaxSetup({
    ...
    <?php endif; ?>
    <?php if($action == 'addLabCollectionCenter'): ?>
    ...
    <?php endif; ?>
    <?php if($action == 'addLabCollectionCenterData'): ?>
        function dataValidate(){
            $('.registerBtn').prop('disabled',true);
            $('.imgLoader').show();
            $('.error-message').remove();
    ...
    <?php if(isset($id) && $id != ''): ?>
        ...
        <?php endif; ?>
        <?php if($action == 'addFeatures'): ?>
            var id = <?php echo e($layoutArr['viewDataObj']->id); ?>

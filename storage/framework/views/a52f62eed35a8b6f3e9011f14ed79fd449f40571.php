    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-body">
                    <form action="<?php echo e(url('branch/saveLabCollectionCenter')); ?>" method="post" role="form" id="entryFrm" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="form-group margine10bot">
                                ...
                                <?php if(isset($layoutArr['viewDataObjs']->address) && $layoutArr['viewDataObjs']->address != ''): ?>
                                    <textarea type="text" name="TBusinessLogisticDtls[address]" class="form-control" rows="3" id="address" autocomplete="off"><?php echo e($layoutArr['viewDataObjs']->address); ?></textarea>
                                <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.iframelightbox', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/branch/add_lab_collection_center_data.blade.php ENDPATH**/ ?>
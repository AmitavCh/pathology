                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-3">
                                ...
                                ?>
                                <label for="exampleInputEmail1"><img src="<?php echo e(asset('public/no.png')); ?>"  width="200" height="150"></label>
                                <?php }else{ ?>
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                        <table style="width:100%">
                                            <tr>
                                                ...
                                                <td width="20%"><?php echo e($viewDataObj->full_name); ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Mobile No  :</b></td>
                                            ...
                                            <tr>
                                                <td><b>Email ID  :</b></td>
                                                <td><?php echo e($viewDataObj->email_id); ?></td>
                                            </tr>
                                                <td><b>Address :</b></td>
...
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/setting/userprofile.blade.php ENDPATH**/ ?>
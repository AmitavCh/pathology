                        ...
                        <div class="table-responsive">            
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($resVal->department_name); ?></td>
                                    <td class="text-center">							
                                        <a class="btn btn-primary btn-sm" href="<?php echo e(URL::to('setting/add_department/'.base64_encode(base64_encode($resVal->id)))); ?>">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <?php if($resVal->status == "N"): ?>
                                        <a class="btn btn-success btn-sm" title="Active Record" onclick="ActiveDepartment(<?php echo e($resVal->id); ?>)">
                                            <i class="fa fa-check-circle-o"></i>
                                        </a> 
                                        <?php endif; ?>
                                        <?php if($resVal->status == "Y"): ?>
                                        <a class="btn btn-warning btn-sm" title="Deactive Record" onclick="DeActiveDepartment(<?php echo e($resVal->id); ?>)">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/setting/add_department.blade.php ENDPATH**/ ?>
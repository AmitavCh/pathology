        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Organization User Listing</h3>
                    <div class="box-tools pull-right">
                        <a href="<?php echo e(URL::to('/branch/create_organization_user_data/')); ?>" class="iframeLarge" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add Organization User</button></a>
                    </div>
                </div>
                <div class="box-body">
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td class="text-center">							
                                        <a class="iframeLarge btn-sm" href="<?php echo e(URL::to('/branch/create_organization_user_data/'.base64_encode(base64_encode($resVal->id)))); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/branch/create_organization_user.blade.php ENDPATH**/ ?>
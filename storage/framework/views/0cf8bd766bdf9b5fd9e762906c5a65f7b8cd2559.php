        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Regional Branch Details</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
                <div class="box-body">
                    <form action="<?php echo e(url('setting/saveRegionalBranch')); ?>" method="post" role="form" id="entryFrm" enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            <div class="box box-success">					
                <div class="box-header">
                    <h3 class="box-title">Regional Branch Listing</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>							
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">							
                                        ...
                                        <a class="btn btn-primary btn-sm" href="<?php echo e(URL::to('setting/add_regional_branch/'.base64_encode(base64_encode($resVal->id)))); ?>">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <?php if($resVal->status == 'N'): ?>
                                        <a class="btn btn-success btn-sm" title="Active Record" onclick="regionalBranchActive(<?php echo e($resVal->id); ?>)">
                                            <i class="fa fa-check-circle-o"></i>
                                        </a> 
                                        <?php endif; ?>
                                        <?php if($resVal->status == 'Y'): ?>
                                        <a class="btn btn-warning btn-sm" title="Deactive Record" onclick="regionalBranchDeactive(<?php echo e($resVal->id); ?>)">
...
<script>
    ...
    function dataValidate(){
        ...
        $.ajax({
            url:baseUrl+'/setting/validateRegionalBranch',
            type: 'post',
            cache: false,
            data:{
    ...
    function regionalBranchActive(record_id){
        if(confirm('Are you sure to Active Record ?')){
            ...
            $.ajax({
                url:baseUrl+'/setting/regionalBranchActive',
                type: 'post',
                cache: false,                   
                data:{
                    "record_id": record_id,
                ...
                success: function(res){     
                    ...
                    if(resp[1] == 'ERROR'){                                         
                        ...
                        window.location.replace(baseUrl+"/setting/add_regional_branch"); 
                    }      
                },
                error: function(xhr, textStatus, thrownError) {
                    //alert('Something went to wrong.Please Try again later...');
    ...
    function regionalBranchDeactive(record_id){
        if(confirm('Are you sure to In-active Record ?')){
            ...
            $.ajax({
                url:baseUrl+'/setting/regionalBranchDeactive',
                type: 'post',
                cache: false,                   
                data:{
                    "record_id": record_id,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/setting/add_regional_branch.blade.php ENDPATH**/ ?>
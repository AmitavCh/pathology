                            ...
                            <?php $__currentLoopData = $menuVal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subMenuKey=>$subMenuVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li style="list-style: none;">
                                    <?php if(in_array($subMenuVal->id,$layoutArr['editSubMenuList'])): ?>
                                        <input type="checkbox" name="subMenuIdArr[]" value="<?php echo e($subMenuVal->id); ?>" class="flat" checked="checked" />
                                    <?php else: ?>
                ...
                <?php else: ?>
                    <li>
                        <?php if(in_array($menuKey,$layoutArr['editMenuList'])): ?>
                            <input type="checkbox" name="menuIdArr[]" value="<?php echo e($menuKey); ?>" class="flat" checked="checked" />
                        <?php else: ?>
...
<?php echo $__env->make('layouts.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/master/role-wise-menu.blade.php ENDPATH**/ ?>
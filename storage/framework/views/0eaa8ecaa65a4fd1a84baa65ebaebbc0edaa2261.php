        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Collection / Lab User Listing</h3>
                    <div class="box-tools pull-right">
                        <a href="<?php echo e(URL::to('branch/add_lab_collection_center_user_data/')); ?>" class="iframeLarge" ><button type="button" class="btn btn-warning"><i class="fa fa-plus"></i> Add Lab/Coll. Admin</button></a>
                    </div>
                </div>
                <div class="box-body">
                            ...
                            <table class="table table-bordered table-striped">
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td><?php echo e(Controller::getDisplayFieldName($resVal->t_business_logistic_dtl_id,'t_business_logistic_dtls',['business_logistic_name'])); ?></td>
                                    ...
                                    <td class="text-center">							
                                        <a class="iframeLarge btn-sm" href="<?php echo e(URL::to('/branch/add_lab_collection_center_user_data/'.base64_encode(base64_encode($resVal->id)))); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/branch/add_lab_collection_center_user.blade.php ENDPATH**/ ?>
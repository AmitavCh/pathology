    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-body">
                    <form action="<?php echo e(url('branch/saveLabCollectionCenterUserDetails')); ?>" method="post" role="form" id="entryFrm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group margine10bot">
                                    ...
                                    <select class="form-control" id="t_business_logistic_dtl_id" name="User[t_business_logistic_dtl_id]">
                                        <?php $__currentLoopData = $layoutArr['collArr']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.iframelightbox', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pathology\resources\views/branch/add_lab_collection_center_user_data.blade.php ENDPATH**/ ?>